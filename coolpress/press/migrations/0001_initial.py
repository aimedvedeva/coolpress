# Generated by Django 3.2.7 on 2022-11-08 21:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(press.models.PostStatus['DRAFT'], 'Draft'), (press.models.PostStatus['PUBLISHED'], 'Published Post')], default=press.models.PostStatus['DRAFT'], max_length=32)),
